    ...
    var body: some View {
            ...
            VStack(alignment: .center){
                ...
                Button(action: {
                    ...
                    let formattedString2 = telephone + "6360644891"
                    let formattedString3 = telephone + "9353491927"
                    
                    guard let url1 = URL(string: formattedString1) else { return }
                    UIApplication.shared.open(url1)
                    guard let url2 = URL(string: formattedString2) else { return }
                    UIApplication.shared.open(url2)
                    guard let url3 = URL(string: formattedString3) else { return }
